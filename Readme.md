...
- [**Hovering toolbar**](https://github.com/ianstormtaylor/slate/blob/master/site/examples/hovering-toolbar.tsx) — showing how a hovering toolbar can be implemented.
