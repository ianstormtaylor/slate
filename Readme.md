...
- [**Plain text**](./site/examples/plaintext.tsx) — showing the most basic case: a glorified `<textarea>`.
- [**Rich text**](./site/examples/richtext.tsx) — showing the features you'd expect from a basic editor.
- [**Markdown preview**](./site/examples/markdown-preview.tsx) — showing how to add key handlers for Markdown-like shortcuts.
- [**Links**](./site/examples/links.tsx) — showing how wrap text in inline nodes with associated data.
- [**Images**](./site/examples/images.tsx) — showing how to use void (text-less) nodes to add images.
- [**Hovering toolbar**](./site/examples/hovering-toolbar.tsx) — showing how a hovering toolbar can be implemented.
- [**Tables**](./site/examples/tables.tsx) — showing how to nest blocks to render more advanced components.
- [**Paste HTML**](./site/examples/paste-html.tsx) — showing how to use an HTML serializer to handle pasted HTML.
- [**Mentions**](./site/examples/mentions.tsx) — showing how to use inline void nodes for simple @-mentions.
- [**See all the examples...**](./site/examples/)
