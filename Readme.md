...
Slate's codebase is a Bun workspace orchestrated with [Turbo](https://turbo.build/). It consists of a handful of packages—although you won't always use all of them. They are:
