...
class Content extends React.Component {
  ...
  shouldComponentUpdate = (props:ContentPropTypes, state:ContentState) => {
  ...
  componentWillUpdate = (props:ContentPropTypes, state:ContentState) => {
  ...
  componentDidUpdate = (props:ContentPropTypes, state:ContentState) => {
    setTimeout(() => {
  ...
  renderVoid = (element, node:NodeType) => {
