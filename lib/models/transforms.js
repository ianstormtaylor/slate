...
const Transforms = {
  ...
  deleteAtRange(range:Selection):NodeType {
  ...
  deleteBackwardAtRange(range:Selection, n:number = 1):NodeType {
    let node = this
  ...
  deleteForwardAtRange(range:Selection, n:number = 1):NodeType {
    let node = this
  ...
  insertFragmentAtRange(range:Selection, fragment:any):NodeType {
  ...
  insertTextAtRange(range:Selection, string:string, marks:Set<typeof Mark>) {
    let node = this
  ...
  addMarkAtRange(range:Selection, mark:typeof Mark | string) {
    let node = this
  ...
  setBlockAtRange(range:Selection, properties:any = {}):NodeType {
    let node = this
  ...
  setInlineAtRange(range:Selection, properties:any = {}):NodeType {
    let node = this
  ...
  splitBlockAtRange(range:Selection, depth:number = 1):NodeType {
    let node = this
  ...
  splitInlineAtRange(range:Selection, depth:number = Infinity):NodeType {
    let node = this
  ...
  splitTextAtRange(range:Selection) {
    let node = this
  ...
  removeMarkAtRange(range:Selection, mark: string | typeof Mark):NodeType {
    let node = this
  ...
  unwrapBlockAtRange(range:Selection, type?:?string, data?:?typeof Data) {
    let node = this
  ...
  unwrapInlineAtRange(range:Selection, type?: ?string, data:?typeof Data) {
    let node = this
  ...
  wrapBlockAtRange(range:Selection, type:string, data:?typeof Data):NodeType {
  ...
  wrapInlineAtRange(range:Selection, type:string, data:typeof Data):NodeType {
    data = Data.create(data)
    let node = this
