...
_Note, if you'd rather use a pre-bundled version of Slate, you can _`npm install slate`_ and retrieve the bundled _`dist/slate.js`_ file! Check out the _[_Using the Bundled Source_](https://github.com/thesunny/slate/tree/28220e7007adc232fa5fefae52c970d7a3531d3d/docs/walkthroughs/using-the-bundled-source.md)_ guide for more information._
