...
If even that's not enough, you can always [read the source itself](https://github.com/thesunny/slate/tree/622ce7a43181cab52a018fc42f988393ef3b0aee/docs/src/README.md), which is heavily commented.
...
All contributions are super welcome! Check out the [Contributing instructions](https://github.com/thesunny/slate/tree/622ce7a43181cab52a018fc42f988393ef3b0aee/docs/Contributing.md) for more info!

Slate is [MIT-licensed](https://github.com/thesunny/slate/tree/622ce7a43181cab52a018fc42f988393ef3b0aee/docs/License.md).
