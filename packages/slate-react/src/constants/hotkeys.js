...
const DELETE_BACKWARD = e => !IS_IOS && (BACKSPACE(e) || SHIFT_BACKSPACE(e))
const DELETE_FORWARD = e => !IS_IOS && (DELETE(e) || SHIFT_DELETE(e))

const DELETE_CHAR_BACKWARD_MAC = isKeyHotkey('ctrl+h')
const DELETE_CHAR_FORWARD_MAC = isKeyHotkey('ctrl+d')
const DELETE_CHAR_BACKWARD = e => DELETE_BACKWARD(e) || (IS_APPLE && !IS_IOS && DELETE_CHAR_BACKWARD_MAC(e))
const DELETE_CHAR_FORWARD = e => DELETE_FORWARD(e) || (IS_APPLE && !IS_IOS && DELETE_CHAR_FORWARD_MAC(e))
