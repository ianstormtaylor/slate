...
const FEATURE_RULES: [string, (window: any) => boolean][] = [
  [
    'inputeventslevel1',
    window => {
...
const ANDROID_API_VERSIONS: [RegExp, number][] = [
  [/^9([.]0|)/, 28],
  [/^8[.]1/, 27],
  [/^8([.]0|)/, 26],
  [/^7[.]1/, 25],
...
/**
 * Get the Android API version from the user agent.
 */
